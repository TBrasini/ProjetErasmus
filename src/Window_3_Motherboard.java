...
import javax.swing.JTextField;
	...
	public class Window_3_Motherboard extends JFrame implements ActionListener{
		public	Window_3_Motherboard(ArrayList <String> Save_data){
			...
			try  {
		        ImageIcon icone = new ImageIcon("C:/Users/T7bra/OneDrive - Groupe INSEEC (POCE)/ERASMUS/Programme Languages/exo/Projet Team2/Image projet/téléchargement (2).jpg");
		        JLabel image = new JLabel(icone);
		        p1.add(image,BorderLayout.NORTH);
				} catch(Exception b) {
					System.out.println("??");
				}
			JTextField text = new JTextField ("  MotherBoard  ");
			p1.add(text);
